...
namespace TwilioApIs.Standard.Apis
{
    ...
    public class AccountsV1PublicKeyApi : BaseApi
    {
        ...
        /// <returns>Returns the ApiResponse of Models.CredentialPublicKey response from the API call.</returns>
        public ApiResponse<Models.CredentialPublicKey> CreateCredentialPublicKey(
                string publicKey,
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the ApiResponse of Models.CredentialPublicKey response from the API call.</returns>
        public async Task<ApiResponse<Models.CredentialPublicKey>> CreateCredentialPublicKeyAsync(
                string publicKey,
                string friendlyName = null,
                string accountSid = null,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.CredentialPublicKey>()
              .RequestBuilder(requestBuilder => requestBuilder
        ...
        /// <returns>Returns the ApiResponse of Models.CredentialPublicKey response from the API call.</returns>
        public ApiResponse<Models.CredentialPublicKey> FetchCredentialPublicKey(
                string sid)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the ApiResponse of Models.CredentialPublicKey response from the API call.</returns>
        public async Task<ApiResponse<Models.CredentialPublicKey>> FetchCredentialPublicKeyAsync(
                string sid,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.CredentialPublicKey>()
              .RequestBuilder(requestBuilder => requestBuilder
        ...
        /// <param name="friendlyName">Optional parameter: A descriptive string that you create to describe the resource. It can be up to 64 characters long..</param>
        /// <returns>Returns the ApiResponse of Models.CredentialPublicKey response from the API call.</returns>
        public ApiResponse<Models.CredentialPublicKey> UpdateCredentialPublicKey(
                string sid,
                string friendlyName = null)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the ApiResponse of Models.CredentialPublicKey response from the API call.</returns>
        public async Task<ApiResponse<Models.CredentialPublicKey>> UpdateCredentialPublicKeyAsync(
                string sid,
                string friendlyName = null,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.CredentialPublicKey>()
