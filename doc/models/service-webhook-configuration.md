...
|  --- | --- | --- | --- |
| `AccountSid` | `string` | Optional | The unique ID of the [Account](https://www.twilio.com/docs/iam/api/account) responsible for this service.<br><br>**Constraints**: *Minimum Length*: `34`, *Maximum Length*: `34`, *Pattern*: `^AC[0-9a-fA-F]{32}$` |
...
| `PreWebhookUrl` | `string` | Optional | The absolute url the pre-event webhook request should be sent to. |
| `PostWebhookUrl` | `string` | Optional | The absolute url the post-event webhook request should be sent to. |
