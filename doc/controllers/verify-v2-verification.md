...
```csharp
VerifyV2VerificationApi verifyV2VerificationApi = client.VerifyV2VerificationApi;
```
...
| `rateLimits` | `object` | Form, Optional | The custom key-value pairs of Programmable Rate Limits. Keys correspond to `unique_name` fields defined when [creating your Rate Limit](https://www.twilio.com/docs/verify/api/service-rate-limits). Associated value pairs represent values in the request that you are rate limiting on. You may include multiple Rate Limit values in each request. |
| `channelConfiguration` | `object` | Form, Optional | [`email`](https://www.twilio.com/docs/verify/email) channel configuration in json format. The fields 'from' and 'from_name' are optional but if included the 'from' field must have a valid email address. |
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.Verification](../../doc/models/verification.md).

## Example Usage

```csharp
string serviceSid = "ServiceSid8";
string to = "+15017122661";
string channel = "sms";
string customFriendlyName = "custom_friendly_name";
string customMessage = "custom_message";
string sendDigits = "ww1";
string locale = "en";
string customCode = "custom_code";
string amount = "€39.99";
string payee = "Acme Inc.";
object rateLimits = ApiHelper.JsonDeserialize<object>("{\"my_rate_limit_key\":\"abc\"}");
object channelConfiguration = ApiHelper.JsonDeserialize<object>("{\"from\":\"foo@bar.com\",\"from_name\":\"Bar Inc.\",\"substitutions\":{\"username\":\"ms. baz\"},\"template_id\":\"Dxxxxxxxxxx\"}");
string appHash = "AAAAAAAAAAA";
string templateSid = "HJaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
string templateCustomSubstitutions = "{\"AppName\": \"MyApp\", \"Contact\":\"12345689\"}";
string deviceIp = "0.000.00.000";
VerificationEnumRiskCheck? riskCheck = VerificationEnumRiskCheck.Enable;
string tags = "{\"tenant_id\": \"12345\"}";
try
{
    ApiResponse<Verification> result = await verifyV2VerificationApi.CreateVerificationAsync(
        serviceSid,
        to,
        channel,
        customFriendlyName,
...
catch (ApiException e)
{
    ...
    if (e is V2ServicesVerifications429ErrorException)
    {
       // TODO: Handle V2ServicesVerifications429ErrorException exception here
    }
}
```
