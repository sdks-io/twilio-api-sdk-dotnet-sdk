...
```csharp
VerifyV2ServiceApi verifyV2ServiceApi = client.VerifyV2ServiceApi;
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.Service2](../../doc/models/service-2.md).
...
bool? skipSmsToLandlines = false;
bool? dtmfInputRequired = false;
string ttsName = "name";
bool? psd2Enabled = false;
bool? doNotShareWarningEnabled = false;
bool? customCodeEnabled = true;
string pushApnCredentialSid = "CRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
string totpIssuer = "test-issuer";
int? totpTimeStep = 30;
int? totpCodeLength = 3;
int? totpSkew = 2;
string defaultTemplateSid = "HJaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
bool? verifyEventSubscriptionEnabled = false;
try
{
    ApiResponse<Service2> result = await verifyV2ServiceApi.CreateServiceAsync(
        friendlyName,
        codeLength,
        lookupEnabled,
        skipSmsToLandlines,
