...
```csharp
TaskrouterV1WorkspaceApi taskrouterV1WorkspaceApi = client.TaskrouterV1WorkspaceApi;
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.Workspace](../../doc/models/workspace.md).
...
try
{
    ApiResponse<Workspace> result = await taskrouterV1WorkspaceApi.FetchWorkspaceAsync(sid);
}
...
```csharp
string sid = "Sid8";
string defaultActivitySid = "WAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
string eventCallbackUrl = "/example";
string friendlyName = "friendly_name";
string timeoutActivitySid = "WAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
try
{
    ApiResponse<Workspace> result = await taskrouterV1WorkspaceApi.UpdateWorkspaceAsync(
        sid,
        defaultActivitySid,
        eventCallbackUrl,
        null,
...
try
{
    await taskrouterV1WorkspaceApi.DeleteWorkspaceAsync(sid);
}
catch (ApiException e)
{
    Console.WriteLine(e.Message);
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ListWorkspaceResponse](../../doc/models/list-workspace-response.md).
...
try
{
    ApiResponse<ListWorkspaceResponse> result = await taskrouterV1WorkspaceApi.ListWorkspaceAsync(friendlyName);
}
catch (ApiException e)
{
    Console.WriteLine(e.Message);
...
try
{
    ApiResponse<Workspace> result = await taskrouterV1WorkspaceApi.CreateWorkspaceAsync(
        friendlyName,
        eventCallbackUrl,
        null,
        null,
