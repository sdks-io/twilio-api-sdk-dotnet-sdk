...
```csharp
TaskrouterV1WorkspaceStatisticsApi taskrouterV1WorkspaceStatisticsApi = client.TaskrouterV1WorkspaceStatisticsApi;
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.WorkspaceStatistics](../../doc/models/workspace-statistics.md).
...
try
{
    ApiResponse<WorkspaceStatistics> result = await taskrouterV1WorkspaceStatisticsApi.FetchWorkspaceStatisticsAsync(
        workspaceSid,
        minutes,
        startDate,
        endDate
