...
```csharp
TaskrouterV1TaskQueueCumulativeStatisticsApi taskrouterV1TaskQueueCumulativeStatisticsApi = client.TaskrouterV1TaskQueueCumulativeStatisticsApi;
```
...
```csharp
FetchTaskQueueCumulativeStatisticsAsync(
    string workspaceSid,
    string taskQueueSid,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.TaskQueueCumulative](../../doc/models/task-queue-cumulative.md).
...
try
{
    ApiResponse<TaskQueueCumulative> result = await taskrouterV1TaskQueueCumulativeStatisticsApi.FetchTaskQueueCumulativeStatisticsAsync(
        workspaceSid,
        taskQueueSid,
        endDate,
        null,
