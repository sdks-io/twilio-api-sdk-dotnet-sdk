...
```csharp
TaskrouterV1TaskQueuesStatisticsApi taskrouterV1TaskQueuesStatisticsApi = client.TaskrouterV1TaskQueuesStatisticsApi;
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ListTaskQueuesStatisticsResponse](../../doc/models/list-task-queues-statistics-response.md).
...
try
{
    ApiResponse<ListTaskQueuesStatisticsResponse> result = await taskrouterV1TaskQueuesStatisticsApi.ListTaskQueuesStatisticsAsync(
        workspaceSid,
        endDate,
        friendlyName,
        minutes,
