...
```csharp
TaskrouterV1WorkflowCumulativeStatisticsApi taskrouterV1WorkflowCumulativeStatisticsApi = client.TaskrouterV1WorkflowCumulativeStatisticsApi;
```
...
```csharp
FetchWorkflowCumulativeStatisticsAsync(
    string workspaceSid,
    string workflowSid,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.WorkflowCumulativeStatistics](../../doc/models/workflow-cumulative-statistics.md).
...
try
{
    ApiResponse<WorkflowCumulativeStatistics> result = await taskrouterV1WorkflowCumulativeStatisticsApi.FetchWorkflowCumulativeStatisticsAsync(
        workspaceSid,
        workflowSid,
        endDate,
        null,
