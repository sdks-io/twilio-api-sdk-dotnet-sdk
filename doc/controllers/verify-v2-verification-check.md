...
```csharp
VerifyV2VerificationCheckApi verifyV2VerificationCheckApi = client.VerifyV2VerificationCheckApi;
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.VerificationCheck](../../doc/models/verification-check.md).
...
string verificationSid = "VEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
string amount = "€39.99";
string payee = "Acme Inc.";
try
{
    ApiResponse<VerificationCheck> result = await verifyV2VerificationCheckApi.CreateVerificationCheckAsync(
        serviceSid,
        code,
        to,
        verificationSid,
