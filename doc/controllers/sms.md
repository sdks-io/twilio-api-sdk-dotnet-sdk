...
| `maxPrice` | `double?` | Form, Optional | [OBSOLETE] This parameter will no longer have any effect as of 2024-06-03. |
...
| `contentRetention` | [`MessageEnumContentRetention?`](../../doc/models/message-enum-content-retention.md) | Form, Optional | Determines if the message content can be stored or redacted based on privacy settings |
| `addressRetention` | [`MessageEnumAddressRetention?`](../../doc/models/message-enum-address-retention.md) | Form, Optional | Determines if the address can be stored or obfuscated based on privacy settings |
...
| `persistentAction` | `List<string>` | Form, Optional | Rich actions for non-SMS/MMS channels. Used for [sending location in WhatsApp messages](https://www.twilio.com/docs/whatsapp/message-features#location-messages-with-whatsapp). |
| `trafficType` | [`MessageEnumTrafficType?`](../../doc/models/message-enum-traffic-type.md) | Form, Optional | - |
...
| `riskCheck` | [`VerificationEnumRiskCheck?`](../../doc/models/verification-enum-risk-check.md) | Form, Optional | Include this parameter with a value of `disable` to skip any kind of risk check on the respective message request. |
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ApiV2010AccountMessage](../../doc/models/api-v2010-account-message.md).

## Example Usage

```csharp
string accountSid = "AccountSid0";
string to = "+14155552345";
string statusCallback = "https://example.com";
string applicationSid = "APaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
List<string> persistentAction = new List<string>
{
    "mailto:test@example.com",
};

MessageEnumScheduleType? scheduleType = MessageEnumScheduleType.Fixed;
string from = "+14155552345";
...
try
{
    ApiResponse<ApiV2010AccountMessage> result = await smsApi.CreateMessageAsync(
        accountSid,
        to,
        statusCallback,
        applicationSid,
