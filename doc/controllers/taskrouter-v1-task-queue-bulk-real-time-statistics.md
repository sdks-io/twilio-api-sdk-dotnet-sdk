...
```csharp
TaskrouterV1TaskQueueBulkRealTimeStatisticsApi taskrouterV1TaskQueueBulkRealTimeStatisticsApi = client.TaskrouterV1TaskQueueBulkRealTimeStatisticsApi;
```
...
```csharp
CreateTaskQueueBulkRealTimeStatisticsAsync(
    string workspaceSid,
    object body = null)
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.TaskQueueBulkRealTimeStatistics](../../doc/models/task-queue-bulk-real-time-statistics.md).
...
try
{
    ApiResponse<TaskQueueBulkRealTimeStatistics> result = await taskrouterV1TaskQueueBulkRealTimeStatisticsApi.CreateTaskQueueBulkRealTimeStatisticsAsync(workspaceSid);
}
